...
public class MessagesConfig extends ConfigManager {
    ...
    public static final ConfigValue KICK_PLAYER_NOT_FOUND = new ConfigValue("punishment_system.kick.player_not_found", "Could not find a Player with the Name " + MessagesParams.PLAYER.getName(), MessagesParams.PLAYER);
